...
def model_data(
    ...
    **model_kwargs,
    ...
    Args:
        ...
        dep_var (str): Column name of dependent variable
        ...
        hypertune (bool, optional): Whether to hypertune model with Bayesian Optimization. Defaults to False.
        hypertune_max_evals (int, optional): Number of evaluations to hypertune. Defaults to 100.
        ...
        hypertune_loss_metric (Optional[Callable], optional): Function to minimise when hypertuning. Arguments of function must contain m (the model), xs (predictors) and y (target). If not specified, cross entropy is used for classification and mean squared error for Regression. Defaults to None.
