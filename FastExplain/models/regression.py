...
class Regression(
    ...
    Args:
        ...
        hypertune_loss_metric (Optional[Callable], optional): Function to minimise when hypertuning. Arguments of function must contain m (the model), xs (predictors) and y (target). If not specified, mean squared error is used. Defaults to None.
